export default {
  ...
  login: {
    platformTitle: 'Low-altitude Defense Integrated Control Platform',
    welcome: 'Welcome to the integrated control platform',
    message: 'UAV detection, identification and countermeasure command & control',
    copyright: 'Copyright © XXXXXX Co., Ltd. All rights reserved',
    username: 'Username',
    password: 'Password',
    register: 'Register',
    ...
    getCode: 'Get code',
    phone: 'Mobile number',
    phonePlaceholder: 'Phone number bound to your account',
    phoneRequired: 'Please input mobile number',
    resetNewPassword: 'New password',
    resetNewPasswordPlaceholder: 'At least 6 characters',
    resetConfirmPassword: 'Confirm password',
    resetConfirmPasswordPlaceholder: 'Re-enter new password',
    resetConfirmRequired: 'Please confirm password',
