...
export const UI = {
  ...
  manualResponseHint: '自动处置专用：触发后进入人工确认窗口；填 0 表示不等待，立即执行。',
  manualResponseManualHint: '人工值守模式下不启用等待窗口，所有动作均需人工确认后下发。',
  alarmLevel: '告警级别',
  planPriority: '优先级',
  weather: '天气因素',
  locatedArea: '所处区域',
  ...
  triggerSortOrder: '排序',
  triggerRuleAdd: '新增规则',
  triggerRuleHint: '按不同天气因素选择对应的执行设备组与设备功能，用于切换有效反制设备。',
